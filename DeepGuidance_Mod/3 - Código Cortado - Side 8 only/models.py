...
class M_Net(nn.Module):
    ...
    def forward(self, x, xgrey):
        ...
        x_2 = F.interpolate(x, size=(int(img_shape / 2), int(img_shape / 2)), mode='bilinear',align_corners=False)
        x_3 = F.interpolate(x, size=(int(img_shape / 4), int(img_shape / 4)), mode='bilinear',align_corners=False)
        x_4 = F.interpolate(x, size=(int(img_shape / 8), int(img_shape / 8)), mode='bilinear',align_corners=False)
        ...
        side_5 = F.interpolate(up5, size=(img_shape, img_shape), mode='bilinear',align_corners=False)
        side_6 = F.interpolate(up6, size=(img_shape, img_shape), mode='bilinear',align_corners=False)
        side_7 = F.interpolate(up7, size=(img_shape, img_shape), mode='bilinear',align_corners=False)
        side_8 = F.interpolate(up8, size=(img_shape, img_shape), mode='bilinear',align_corners=False)
...
class DG_Net(nn.Module):
    ...
    def forward(self, x, ImgGreys):
        ...
        ImgGreys_2 = F.interpolate(ImgGreys, size=(int(img_shape / 2), int(img_shape / 2)), mode='bilinear',align_corners=False)
        ImgGreys_3 = F.interpolate(ImgGreys, size=(int(img_shape / 4), int(img_shape / 4)), mode='bilinear',align_corners=False)
        ImgGreys_4 = F.interpolate(ImgGreys, size=(int(img_shape / 8), int(img_shape / 8)), mode='bilinear',align_corners=False)
